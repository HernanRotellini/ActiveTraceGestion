...
import type { ComentarioResponse } from '@/features/tareas-internas/types'

const mockComentarios: ComentarioResponse[] = [
  { id: '1', tarea_id: 't1', autor_id: 'u1', texto: 'Comentario principal', created_at: '2026-01-10T10:00:00Z' },
  { id: '2', tarea_id: 't1', autor_id: 'u2', texto: 'Respuesta', created_at: '2026-01-10T11:00:00Z' },
]
...
describe('TareasInternas', () => {
  ...
  it('ComentarioList muestra comentarios', () => {
